...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/SEX-SUX/RUDRAXMUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# ❖ SUPPORT AND CONTACT INFORMATION - PROVIDE YOUR OWN SUPPORT CHANNELS 
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+LNbhIAM1l4NjMWM1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+LNbhIAM1l4NjMWM1")
